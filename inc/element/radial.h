...
public:
	Radial(spread_func spr, double focus, double radius, const Matrix3& world2canonical, const std::vector<std::pair<double, Color_v> >& stops)
	{
	...
	Color sample(double x, double y) override
	{
		...
		double b = -2*p.x()*focus;
		double c = focus*focus - radius*radius; //TODO: precompute this

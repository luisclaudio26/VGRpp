...
all: render.o parser.o rect.o vector2.o RawElement.o matrix3.o
	$(CC) $(CFLAGS) $(CLIBS) render.o parser.o rect.o vector2.o RawElement.o matrix3.o -o $(EXEC) main.cpp
	make clean
